...
class SessionService:
    ...
    def open_session(self, session_id: str, started_at: float) -> tuple[Session, str | None]:
        ...
        A differenza di start(), non solleva se una sessione è già attiva: il
        client permette Start -> Stop -> Start e, se lo Stop non arriva (crash,
        finestra chiusa), la sessione precedente resterebbe aperta per sempre.
